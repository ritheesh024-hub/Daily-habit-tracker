  ...
  return (
    <div id="habit-list-section" className="space-y-1.5 sm:space-y-2">
      ...
      {habits.length === 0 ? (
        ...
        >
          <p className="font-medium text-zinc-700 dark:text-zinc-300">No habits yet.</p>
          <p className="text-zinc-500 dark:text-zinc-400">Add your first habit from Profile → Manage Habits.</p>
        </div>
      ) : (
